...
var my_scheduled_event = [
	...
	{ "id": "3月ポスドク採用", "optional": true, "effect": [{ "type": "postdoc_hour_year", "value": 40 }, { "type": "number_of_postdoc", "value": 1 }] },
	null,
	# 4月
	...
	null,
	{ "id": "10月科研費C申請", "effect": [{ "type": "private_hour_tmp", "value": 100}, { "type": "apply_kaken", "wait": 7, "year": 2, "money": 2 } ], "require": "not_applied" },
